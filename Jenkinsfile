...
// for jenkin in OCP
def buildBarImage = "docker-registry.default.svc:5000/jenkins/ace-buildbar:12.0.4.0-ubuntu"
def ocImage = "docker-registry.default.svc:5000/jenkins/oc-deploy:4.10"
